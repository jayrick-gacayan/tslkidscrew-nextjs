...
export const BEFORE_OR_AFTER_SCHOOL_TOS: TOSInfos[] = [
  ...
  {
    num: 'four',
    text: 'I understand that if I do not pay by the 22th of each month that a $5 per day late fee will be assessed on my monthly fee.'
  },
  {
    num: 'five',
  ...
  {
    num: 'seven',
    text: 'I waive liability for any accidental injury that occurs on site while during program hours.'
  },
  {
    num: 'eight',
