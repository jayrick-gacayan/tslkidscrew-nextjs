    ...
    <div className="space-y-8">
      <div className="space-y-2 text-black">
        ...
        <div className="space-y-2">
          {
            vacationCamps.map((val: Pick<VacationCampSetting, 'id' | 'name' | 'month' | 'year'>, idx: number) => {
              return (
                <div key={`${val.id}=${idx}`}>
                  <InputCheckboxCustom labelText={val.name}
                    ...
                    name='vacation-camp[]'
                    checked={
                      vacationCampsMemo.value.find((value: Pick<VacationCampSetting, 'id' | 'name' | 'month' | 'year'>) => {
                        ...
                        vacationCampsSet(
                          fieldInputValue(
                            !vacationCampsMemo.value.find(
                              (vacCamp: Pick<VacationCampSetting, 'id' | 'name' | 'month' | 'year'>) => {
